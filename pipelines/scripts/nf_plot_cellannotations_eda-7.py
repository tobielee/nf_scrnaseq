...
methods = [
    ...
    "ToppCell",
    "CellMarker2",
    "scanvipred_mouse-tabula-muris-senis-droplet",
    "celltypist_mouse-tabula-muris-senis-droplet.majority_voting",
    "seurat_clusters",
    # Add more methods as needed
]


def generate_plots(adata_query, sample_name, method = methods, plot_params = plot_params):
    plots_path = "plots"
...
if __name__ == '__main__':
    ...
    if DATA_INTEGRATED:
        ...
        adata_query = mydata
        generate_plots(adata_query,DATASET_LABEL)
    else:
        ...
        if isinstance(mydata, dict):
            for sample_name, adata_query in mydata.items():
                generate_plots(adata_query, sample_name)
        else:
